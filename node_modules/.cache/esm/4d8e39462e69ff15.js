let capitalizeString;_2e6‍.w("./File6",[["capitalizeString",["capitalizeString"],function(v){capitalizeString=v}]]);//Creating Strings using Template Literals
const person = {
    name : "Lufi Dono",
    age: 26
};
...
_2e6‍.g.console.log(temp);


//Diff b/w *Import* and *require*

const cap = capitalizeString("hello!");
_2e6‍.g.console.log(cap);